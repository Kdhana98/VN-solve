...
# choose a seed to train model from [3, 7, 11, 13, 29]
seed = 29
# Set seed for reproducibility
random.seed(seed)
#random, ellipse, random
visualization = 'random'
# choose model size from "small" or "medium"
model_size = 'medium'
# this file is for training the grayscale images
coloring = 'gray'
tv = 3
